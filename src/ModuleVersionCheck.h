...
#define ModuleVersion_ModuleName "HeatingActuator"
#define ModuleVersion_knxprod_h HTA_ModuleVersion
#define ModuleVersion_version_h MODULE_HeatingActuator_ETS
